...
CREATE OR REPLACE FUNCTION public.register_device(p_device_code text, p_name text, p_store_id uuid, p_company_id uuid, p_group_id uuid, p_store_code text DEFAULT NULL::text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
